 ...
 */
function generateBusinessStructuredData(business, localHub) {
 ...
 */
function generateCategoryStructuredData(category, localHub) {
 ...
 */
function generateSearchStructuredData(additionalData, localHub) {
