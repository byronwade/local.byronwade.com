...
import instantPreloader from "./instantPreloader";
import instantPageLoader from "./instantPageLoader";
import streamingSearchEngine from "./streamingSearch";
import { CompressedSearchIndex } from "./compressedSearchIndex";
import advancedPrefetcher from "./advancedPrefetching";
import ultraAggressivePrefetcher from "./ultraAggressivePrefetching";
import imageHoverPrefetcher from "./imageHoverPrefetching";
import edgeStreamingManager from "./edgeStreaming";
import partialPrerenderingManager from "./partialPrerendering";
