...
export class StructuredDataGenerator {
	constructor(siteConfig = {}) {
		this.siteConfig = {
			name: siteConfig.name || "Local ByteRover Directory",
			url: siteConfig.url || "https://local.byronwade.com",
			logo: siteConfig.logo || "https://local.byronwade.com/logos/ThorbisLogo.webp",
