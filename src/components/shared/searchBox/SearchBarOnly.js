...
const SearchBarOnly = () => {
	...
	return (
		<form className="relative z-10 flex flex-col w-full h-full min-w-0 p-2 bg-background border border-border rounded-md focus-within:border-primary focus:border-primary" onSubmit={handleFormSubmit}>
