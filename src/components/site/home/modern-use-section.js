    ...
    const demos = {
      'search-demo': (
        <div className="relative bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-2xl p-8 h-64">
          <div className="absolute inset-4 bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden">
            <div className="p-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <Search className="w-5 h-5 text-gray-400" />
                <span className="text-gray-600 dark:text-gray-300">Find plumbers near me...</span>
              </div>
            </div>
      ...
      'compare-demo': (
        <div className="relative bg-gradient-to-br from-purple-50 to-pink-100 dark:from-purple-950/20 dark:to-pink-950/20 rounded-2xl p-8 h-64">
          <div className="grid grid-cols-2 gap-4 h-full">
            {[1, 2].map(i => (
              <div key={i} className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-4">
                <div className="w-full h-20 bg-gray-100 dark:bg-gray-800 rounded-lg mb-3"></div>
        ...
        <div className="relative bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-950/20 dark:to-emerald-950/20 rounded-2xl p-8 h-64">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 h-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">Book Appointment</span>
            </div>
            <div className="grid grid-cols-7 gap-2 mb-4">
              {Array.from({ length: 21 }, (_, i) => (
                <div key={i} className={`h-8 rounded ${i === 10 ? 'bg-green-500 text-white' : 'bg-gray-100 dark:bg-gray-800'} flex items-center justify-center text-sm`}>
                  {i + 1}
                </div>
              ))}
            </div>
      ...
      'profile-demo': (
        <div className="relative bg-gradient-to-br from-amber-50 to-orange-100 dark:from-amber-950/20 dark:to-orange-950/20 rounded-2xl p-8 h-64">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-4 h-full overflow-hidden">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/30 rounded-xl"></div>
              <div>
      ...
      'operations-demo': (
        <div className="relative bg-gradient-to-br from-cyan-50 to-blue-100 dark:from-cyan-950/20 dark:to-blue-950/20 rounded-2xl p-8 h-64">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-4 h-full">
            <div className="flex justify-between items-center mb-4">
              <span className="font-semibold text-gray-900 dark:text-white">Team Dashboard</span>
            ...
            <div className="space-y-3">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="flex items-center gap-3 p-2 rounded-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="w-16 h-6 bg-blue-100 dark:bg-blue-900/30 rounded"></div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="relative bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-950/20 dark:to-purple-950/20 rounded-2xl p-8 h-64">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-4 h-full">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">Growth Analytics</span>
            </div>
            <div className="space-y-3">
    ...
    >
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className={`flex justify-center mb-16 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="inline-flex p-1 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
        ...
        <div className={`text-center mt-20 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="inline-flex flex-col sm:flex-row gap-4">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 px-8 py-4 rounded-2xl text-lg font-semibold transition-all duration-300"
            >
              Watch Demo
