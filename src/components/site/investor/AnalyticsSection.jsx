...
const conversionConfig = {
	conversion: { label: "Booking Conversion", color: "#10b981" },
};
...
const npsConfig = {
	nps: { label: "NPS", color: "#a855f7" },
};

const npsData = [{ name: "NPS", nps: 61, fill: "#a855f7" }];
			...
			<div className="rounded-xl border bg-background p-3" style={{ height: 260 }}>
				<ResponsiveContainer width="100%" height="100%">
					<AreaChart data={usersData} margin={{ left: 8, right: 8, top: 8, bottom: 8 }}>
						...
						<Area type="monotone" dataKey="users" stroke="#2563eb" fill="#2563eb" fillOpacity={0.15} />
						<Tooltip />
						<Legend />
					</AreaChart>
				</ResponsiveContainer>
				...
				<div className="rounded-xl border bg-background p-3" style={{ height: 220 }}>
					<ResponsiveContainer width="100%" height="100%">
						<RadialBarChart data={npsData} innerRadius={60} outerRadius={90} startAngle={90} endAngle={-270}>
							<RadialBar minAngle={15} background dataKey="nps" cornerRadius={8} fill="#a855f7" />
