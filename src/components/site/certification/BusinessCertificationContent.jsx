					...
					{certificationStages.map((stage, index) => (
						<Card key={index} className="p-4 transition-all duration-200 hover:shadow-md hover:scale-105">
							<div className="flex items-center mb-3">
								<div className={`flex items-center justify-center w-8 h-8 text-sm font-bold text-white rounded-full ${stage.difficulty === "Elite" ? "bg-amber-600" : stage.difficulty === "Expert" ? "bg-red-600" : stage.difficulty === "Intensive" ? "bg-blue-600" : "bg-muted-foreground"}`}>{stage.stage}</div>
						...
						<div className="space-y-4">
							{requirements.map((requirement, index) => (
								<div key={index} className="flex items-start space-x-3">
									<CheckCircle className="flex-shrink-0 mt-1 w-5 h-5 text-green-500" />
