			...
			<footer className="relative w-full text-gray-900 dark:text-white bg-neutral-900 dark:bg-neutral-900 border-t border-neutral-800 dark:border-neutral-900">
				...
				<div className="px-4 py-20 lg:px-24">
					...
					<div className="grid grid-cols-2 gap-12 mb-16 md:grid-cols-4 lg:grid-cols-6">
						...
						{/* Industries (inline full-width at bottom) */}
						<div className="md:col-span-4 lg:col-span-6">
							...
							<div className="flex flex-wrap gap-x-4 gap-y-2 text-slate-300">
								<a href="/industries" className="text-sm hover:text-blue-300">
									Overview
								</a>
								<a href="/field-management-software" className="text-sm hover:text-blue-300">
									Field Management
								</a>
								<a href="/construction-management-software" className="text-sm hover:text-blue-300">
									Construction
								</a>
								<a href="/retail-operations-platform" className="text-sm hover:text-blue-300">
									Retail
								</a>
								<a href="/healthcare-operations-platform" className="text-sm hover:text-blue-300">
									Healthcare
								</a>
								<a href="/hospitality-operations-platform" className="text-sm hover:text-blue-300">
									Hospitality
								</a>
								<a href="/automotive-shop-software" className="text-sm hover:text-blue-300">
									Automotive
								</a>
								<a href="/property-management-platform" className="text-sm hover:text-blue-300">
									Property Mgmt
								</a>
								<a href="/logistics-operations-platform" className="text-sm hover:text-blue-300">
									Logistics
								</a>
								<a href="/academy-learning-platform" className="text-sm hover:text-blue-300">
									Academy
								</a>
								<a href="/admin-operations-console" className="text-sm hover:text-blue-300">
									Admin Console
								</a>
								<a href="/agriculture-management-software" className="text-sm hover:text-blue-300">
									Agriculture
								</a>
								<a href="/field-service-management" className="text-sm hover:text-blue-300">
									Field Service Management
								</a>
								<a href="/beauty-salon-software" className="text-sm hover:text-blue-300">
									Beauty Salon
								</a>
								<a href="/business-management-platform" className="text-sm hover:text-blue-300">
									Business Mgmt
								</a>
								<a href="/ecommerce-operations-platform" className="text-sm hover:text-blue-300">
									eCommerce
								</a>
								<a href="/energy-services-software" className="text-sm hover:text-blue-300">
									Energy
								</a>
								<a href="/fitness-studio-software" className="text-sm hover:text-blue-300">
									Fitness
								</a>
								<a href="/localhub-marketplace-platform" className="text-sm hover:text-blue-300">
									LocalHub
								</a>
								<a href="/nonprofit-operations-platform" className="text-sm hover:text-blue-300">
									Nonprofit
								</a>
								<a href="/professional-services-platform" className="text-sm hover:text-blue-300">
									Professional Services
								</a>
								<a href="/real-estate-operations-platform" className="text-sm hover:text-blue-300">
									Real Estate
								</a>
							</div>
						</div>
