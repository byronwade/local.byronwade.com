      ...
      <div className="relative px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="max-w-3xl mx-auto text-xl sm:text-2xl text-gray-600 dark:text-gray-300 mb-8">
            ...
            {/* Popular Services */}
            <div className="mb-16">
              <p className="text-gray-600 dark:text-gray-300 mb-4">Popular services this week:</p>
              <div className="flex flex-wrap justify-center gap-3">
                {popularServices.map((service) => (
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="h-auto p-3 bg-white/60 hover:bg-white border-gray-200 hover:border-blue-300 transition-all"
                  >
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Find & book services</p>
                    </div>
                  </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Join the growing Thorbis community transforming local services</p>
            </div>
            
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 mb-2">{platformStats.businesses}</div>
                <div className="text-gray-600">Active Businesses</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">{platformStats.completedJobs}</div>
                <div className="text-gray-600">Jobs Completed</div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-2">
                  <Star className="w-6 h-6 fill-yellow-400 text-yellow-400" />
                  <span className="text-3xl font-bold text-yellow-600">{platformStats.avgRating}</span>
                </div>
          ...
          <div className="text-center mt-16">
            ...
            <p className="text-gray-600 mt-4">Free to start • No credit card required</p>
          </div>
        </div>
      </div>
    </section>
