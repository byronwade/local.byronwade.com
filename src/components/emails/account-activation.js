...
const AccountActivation = ({ firstName, url }) => (
	<Html lang="en">
		...
		<Body style={{ fontFamily: "Arial, sans-serif", fontSize: "16px", color: "#333" }}>
			<Container>
				<Section>
					<Text>Hi {firstName},</Text>
					<Text>Thank you for signing up for Thorbis! Please activate your account by clicking the button below:</Text>
					<Button href={url} style={{ backgroundColor: "#007bff", color: "#fff", padding: "10px 20px", textDecoration: "none", borderRadius: "5px" }}>
						Activate Account
					</Button>
