		...
		<div>
			...
			<div className="mt-4 space-y-4">
				<Card className="relative flex flex-row px-8 py-4">
					<FaBuilding className="w-8 h-8 mr-4 text-gray-700 dark:text-gray-300" />
					<div>
				...
				<Card className="relative flex flex-row px-8 py-4">
					<FaStar className="w-8 h-8 mr-4 text-gray-700 dark:text-gray-300" />
					<div>
				...
				<Card className="relative flex flex-row px-8 py-4">
					<FaComment className="w-8 h-8 mr-4 text-gray-700 dark:text-gray-300" />
					<div>
				...
				<Card className="relative flex flex-row px-8 py-4">
					<FaImage className="w-8 h-8 mr-4 text-gray-700 dark:text-gray-300" />
					<div>
				...
				<Card className="relative flex flex-row px-8 py-4">
					<FaExclamationCircle className="w-8 h-8 mr-4 text-gray-700 dark:text-gray-300" />
					<div>
