								...
								<div className="space-y-6">
									...
									{planData.services.length === 0 ? (
										<div className="text-center py-12 border-2 border-dashed border-gray-300 rounded-lg">
											...
											<p className="text-gray-500 mb-4">Add services that will be included in this plan</p>
									...
									<div>
										...
										{planData.benefits.length === 0 ? (
											<div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
												...
												<h3 className="font-medium text-gray-900 mb-1">No benefits added yet</h3>
												<p className="text-gray-500 text-sm mb-3">Add benefits to make your plan attractive</p>
