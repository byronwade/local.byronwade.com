								...
								<div className="space-y-4">
									<div className="flex items-center space-x-3">
										...
										<div className="flex-1">
											<p className="text-sm">Completed "Plumbing Tools Overview"</p>
									...
									<div className="flex items-center space-x-3">
										...
										<div className="flex-1">
											<p className="text-sm">Started "HVAC Energy Efficiency"</p>
									...
									<div className="flex items-center space-x-3">
										...
										<div className="flex-1">
											<p className="text-sm">Earned "7-Day Learning Streak" badge</p>
