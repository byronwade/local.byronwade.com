...
export default function LocalHubPage() {
	...
	return (
		<main className="min-h-screen w-full bg-white dark:bg-neutral-900">
			...
			<section className="relative overflow-hidden py-24" id="hero-section">
				<div className="w-full max-w-[1200px] mx-auto px-6 text-center">
					<MotionHero>
						...
						<h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6 text-neutral-900 dark:text-white">
							Launch your local
							<br />
							<span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">business directory</span>
						</h1>
						...
						<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
							<MotionButton href="/signup" className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl">
			...
			{/* Mobile motion enhancements: intentionally omitted from Server Component to satisfy RSC rules */}
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
						{[
							...
							<div key={idx} className="text-center">
								<div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">{stat.number}</div>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<div>
							...
							<h2 className="text-4xl md:text-5xl font-bold mb-6 text-neutral-900 dark:text-white">
								Turn your local knowledge into
								<span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent"> recurring revenue</span>
							</h2>
							...
							<div className="space-y-6">
								{[
									...
									<div key={idx} className="flex items-start gap-4 p-6 rounded-2xl bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 shadow-sm">
										<div className={`flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br ${stream.gradient} flex items-center justify-center`}>
							...
							<div className="mt-8">
								<MotionButton href="/revenue-calculator" className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 font-bold hover:from-green-700 hover:to-emerald-700 transition-all duration-300">
						...
						<MotionSection variant="scaleIn" delay={0.2} className="relative">
								...
								<div className="flex items-end justify-between gap-2 h-40 mb-6">
									{[20, 35, 45, 55, 70, 85, 95, 110, 125, 135, 150, 165].map((height, idx) => (
										<div key={idx} className="flex-1 flex flex-col items-center gap-2">
											<div className="w-full bg-gradient-to-t from-green-500 to-emerald-400 rounded-t-sm" style={{ height: `${height}px` }} />
							...
							<div className="absolute -top-4 -right-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-black rounded-2xl p-4 shadow-lg rotate-12">
					...
					{[
						...
						<MotionGridItem key={idx}>
							<div className="flex flex-col lg:flex-row items-center gap-8">
								{/* Step Number */}
								<div className={`flex-shrink-0 w-20 h-20 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center text-white font-bold text-xl shadow-lg`}>{item.step}</div>
			...
			{/* Why LocalHub */}
			<section className="w-full mt-20 px-4 sm:px-8 bg-gradient-to-b from-neutral-50 to-white dark:from-neutral-950 dark:to-neutral-900 py-16">
				...
				<MotionGrid className="w-full max-w-[1400px] mx-auto grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
					{[
						{ title: "Pre-built Taxonomy", desc: "Launch faster with our comprehensive database of cities, neighborhoods, and business categories.", Icon: Globe, gradient: "from-blue-500 to-cyan-500" },
						{ title: "Lightning Search", desc: "Advanced search with filters, facets, and AI-powered relevance tuned specifically for local discovery.", Icon: Search, gradient: "from-purple-500 to-pink-500" },
						{ title: "Rich Business Profiles", desc: "Complete business pages with photos, hours, services, menus, contact info, and customer reviews.", Icon: Building2, gradient: "from-green-500 to-emerald-500" },
						{ title: "Smart Moderation", desc: "AI-powered content moderation with flagging, dispute resolution, and comprehensive audit trails.", Icon: Shield, gradient: "from-orange-500 to-red-500" },
						{ title: "Advanced Analytics", desc: "Track performance with detailed metrics on traffic, clicks, calls, leads, and conversions.", Icon: BarChart3, gradient: "from-indigo-500 to-purple-500" },
						{ title: "Global Ready", desc: "Multi-language support with localized URLs, metadata, and currency for international expansion.", Icon: Globe, gradient: "from-teal-500 to-blue-500" },
						...
						<MotionGridItem key={title}>
							<div className="group relative rounded-2xl border bg-white dark:bg-neutral-950 p-8 shadow-sm hover:shadow-xl transition-all duration-300">
								...
								<div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br ${gradient} p-0.5 mb-6`}>
									<div className="flex items-center justify-center w-full h-full rounded-xl bg-white dark:bg-neutral-950">
			...
			<section className="w-full mt-20 px-4 sm:px-8 py-16">
					...
					<MotionGridItem>
						<div className="bg-green-50 dark:bg-green-950/20 rounded-3xl p-8 border-2 border-green-200 dark:border-green-800 relative">
							...
							<div className="absolute -top-4 left-1/2 -translate-x-1/2">
								<span className="rounded-full bg-gradient-to-r from-green-500 to-emerald-500 px-4 py-1 text-sm font-medium text-white">Recommended</span>
							</div>
				...
				<MotionSection className="w-full max-w-[1400px] mx-auto mt-16 text-center">
					<div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-3xl p-8 text-white">
						...
						<MotionButton href="/signup" className="inline-flex items-center gap-2 rounded-xl bg-white text-green-600 px-8 py-4 font-bold text-lg hover:bg-green-50 transition-all duration-300">
							Start earning today
							<ArrowRight className="h-5 w-5" />
						</MotionButton>
					</div>
			...
			<section className="w-full mt-20 px-4 sm:px-8">
						...
						<MotionGridItem key={idx}>
							<div className="group relative rounded-2xl border bg-white dark:bg-neutral-950 p-6 shadow-sm hover:shadow-xl transition-all duration-300">
								...
								<div className="flex items-center gap-3">
									<div className={`flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br ${testimonial.bg} text-white font-semibold text-sm`}>{testimonial.avatar}</div>
									<div>
				...
				{/* Social Proof Bar */}
				<MotionSection className="w-full max-w-[1400px] mx-auto mt-16 text-center">
					<div className="inline-flex items-center gap-8 rounded-2xl bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-950/50 dark:to-green-950/50 px-8 py-6">
			...
			<section id="pricing" className="py-24 bg-gradient-to-b from-white to-neutral-50 dark:from-neutral-900 dark:to-neutral-950">
				<MotionSection className="w-full max-w-[1200px] mx-auto px-6 text-center">
					...
					<MotionSection className="max-w-2xl mx-auto">
						<div className="relative bg-gradient-to-b from-blue-600 to-purple-600 text-white rounded-3xl p-12 shadow-2xl">
							<div className="absolute -top-4 left-1/2 -translate-x-1/2">
								<span className="rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 px-6 py-2 text-sm font-bold text-black">Revenue Share Model</span>
							</div>
							...
							<div className="text-center">
								<MotionButton href="/signup" className="inline-flex items-center gap-2 bg-white text-blue-600 px-10 py-5 rounded-xl font-bold text-xl hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl">
									Start building for free
			...
			<section className="py-24 bg-gradient-to-b from-neutral-50 to-white dark:from-neutral-950 dark:to-neutral-900">
						...
						<MotionGridItem key={item.q}>
							<div className="group p-8 rounded-2xl border bg-white dark:bg-neutral-950 hover:shadow-lg transition-all duration-300 h-full">
								<div className="flex items-start gap-4">
									<div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold text-sm">{String(idx + 1).padStart(2, "0")}</div>
									<div className="flex-1">
				...
				<MotionSection className="text-center mt-16">
					<div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white">
						...
						<MotionButton href="/contact" className="inline-flex items-center gap-2 bg-white text-blue-600 px-8 py-4 rounded-xl font-bold hover:bg-blue-50 transition-all duration-300">
			...
			<section className="w-full mt-20 px-4 sm:px-8 mb-20">
				<MotionSection className="w-full max-w-[1400px] mx-auto">
					<div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 p-12 text-center text-white">
						{/* Background Pattern */}
						...
						<div className="relative z-10 max-w-4xl mx-auto">
							...
							<h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
								...
								<br />
								<span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">in minutes, not months</span>
							</h2>
							...
							<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
								<MotionButton href="/signup" className="group inline-flex items-center gap-2 rounded-xl bg-white text-blue-600 px-8 py-4 font-bold text-lg hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl">
									Start free trial
