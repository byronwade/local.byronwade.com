...
import { BookOpen, Newspaper, GraduationCap, Calendar, Search, Clock, User, MapPin, TrendingUp, Star, ArrowRight, ExternalLink, Filter, Tag } from "lucide-react";

export const metadata = {
	title: "Resources Hub - Blog, News, Learning & Events | Local Business Directory",
	description: "Discover insights, industry news, educational content, and local business events. Stay informed and learn strategies to grow your local business.",
	keywords: "business blog, local business news, learning resources, business events, education, industry insights, marketing tips, growth strategies",
	openGraph: {
		title: "Resources Hub - Blog, News, Learning & Events",
		description: "Discover insights, industry news, educational content, and local business events for local business growth.",
		type: "website",
	},
	twitter: {
		card: "summary_large_image",
		title: "Resources Hub - Blog, News, Learning & Events",
		description: "Discover insights, industry news, educational content, and local business events.",
	},
	robots: {
		index: true,
		follow: true,
	...
	return (
		<div className="bg-gradient-to-r from-green-600 to-teal-600 text-white py-16">
			<div className="container mx-auto px-4 text-center">
				...
				<p className="text-xl mb-8 max-w-3xl mx-auto">Everything you need to grow your local business: expert insights, industry news, educational content, and networking events.</p>
