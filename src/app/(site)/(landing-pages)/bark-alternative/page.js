...
import { CheckCircle, XCircle, Star, Users, DollarSign, Shield, Zap, Globe, MessageSquare, Calendar, Award, Search, BarChart3, Settings, Wrench, Home, ArrowRight } from "lucide-react";

export default function BarkAlternative() {
	return (
				...
				<div className="relative px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8 lg:py-24">
					<div className="text-center">
						...
						<h1 className="mb-6 text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
							Bark vs <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/80">Thorbis</span>
						</h1>
						...
						<table className="w-full">
							<thead className="bg-primary text-primary-foreground">
								<tr>
									...
									<th className="px-6 py-4 text-center font-semibold">Bark</th>
							...
							<tbody className="bg-card divide-y divide-border">
								<tr className="hover:bg-muted/50 transition-colors">
									...
									<td className="px-6 py-4 text-center text-destructive font-semibold">$250+</td>
								...
								<tr className="hover:bg-muted/50 transition-colors">
									...
									<td className="px-6 py-4 text-center text-green-600 dark:text-green-400 font-bold">High Volume</td>
								</tr>
								<tr className="hover:bg-muted/50 transition-colors">
