...
export default function BizProfileClient({ resolvedParams, initialBusiness, seoData }) {
	...
	useEffect(() => {
		const loadBusinessData = () => {
			try {
				...
				const fallbackBusiness = {
					id: resolvedParams.id || "fallback",
					name: "Business Not Found",
					slug: resolvedParams.id || "not-found",
		...
		loadBusinessData();
	}, [resolvedParams.id, initialBusiness]);
