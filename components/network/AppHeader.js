...
import { Home, Users, Briefcase, MessageSquare, Bell, Menu, Settings } from "lucide-react";
				...
				<div className="flex flex-row items-center w-full space-x-6">
					<Link href="/network" className="flex items-center space-x-3 text-xl font-bold group">
						<div className="relative">
							<Image src="/ThorbisLogo.webp" alt="Thorbis Network" width={50} height={50} className="w-12 h-12 transition-transform duration-200 group-hover:scale-105" />
