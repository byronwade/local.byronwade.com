...
export default function ActiveBusiness() {
	return (
		<div className="mt-10">
			<h2 className="mb-1 text-2xl font-bold leading-9 text-left ">These buissness are linked to your account</h2>
			<p className="text-sm leading-6 text-left text-muted-foreground">Select a company from bellow</p>
