...
export default function VerifyAccount() {
	return (
		<div>
			...
			<div className="mt-6">
				<p className="text-sm leading-6 text-left text-gray-600 dark:text-gray-300">If you are unable to find the email to verify your account please head here to resend a link</p>
