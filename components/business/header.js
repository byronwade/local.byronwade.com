...
export default function Header() {
	...
	const businessNavItems = [
		{ href: "/business", text: "Overview", icon: BarChart3 },
		{ href: "/business/profile", text: "Profile", icon: User },
		{ href: "/business/jobs", text: "Jobs", icon: Briefcase },
		{ href: "/business/billing", text: "Billing", icon: CreditCard },
		{ href: "/business/support", text: "Support", icon: HelpCircle },
		{ href: "/business/settings", text: "Settings", icon: Settings },
	];
						...
						<DropdownMenu>
							...
							<DropdownMenuContent className="w-64 z-[90] bg-card/95 backdrop-blur-md border border-border/50">
								...
								<DropdownMenuItem asChild>
									<Link href="/business/jobs">View all projects</Link>
								</DropdownMenuItem>
							</DropdownMenuContent>
						</DropdownMenu>
					</div>
