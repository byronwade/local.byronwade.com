...
// Generate businesses for the home page
const allBusinesses = generateBusinesses(50);
const businesses = allBusinesses.slice(0, 20).map((business) => ({
	...business,
	// Transform data to match BusinessCard component expectations
	image: business.photos?.[0] || business.logo || "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&h=300&fit=crop",
...
export default function Home() {
	const jsonLd = {
		...
		potentialAction: {
			"@type": "SearchAction",
			target: "https://local.byronwade.com/search?q={search_term_string}",
		...
		mainEntity: {
			...
			itemListElement: businesses.map((business, index) => ({
				...
				item: {
					...
					url: `https://local.byronwade.com/business/${business.id}`,
					telephone: business.phone,
					address: {
						"@type": "PostalAddress",
						streetAddress: business.address,
						addressLocality: business.location.split(",")[0],
						addressRegion: business.location.split(", ")[1],
					},
	...
	return (
		<>
			...
			<main className="relative bg-background">
				{/* Hero Section - Full width with aligned content */}
				...
				{/* Main Content - Match header padding exactly */}
				<div className="relative bg-background">
					{/* Business Sections - Aligned with header and hero */}
					<div className="px-4 lg:px-24">
						<div className="pt-6 pb-8 space-y-12 sm:pt-8 sm:pb-12 sm:space-y-16 lg:pt-12 lg:pb-16 lg:space-y-20">
					...
					{/* Feature Sections - Match header padding */}
					<div className="py-16 space-y-20 sm:py-20 sm:space-y-24 lg:py-24 lg:space-y-28">
						{/* Verified Reviews & Trust Section */}
						<div className="px-4 lg:px-24">
							<div className="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 shadow-2xl isolate sm:rounded-3xl border border-emerald-400/20">
								...
								<div className="px-6 pt-16 sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
									<div className="max-w-md mx-auto text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
										...
										<h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl mb-6">Real Reviews, Real People</h2>
										<p className="text-lg leading-8 text-white/90 mb-8 sm:text-xl">Our blockchain-verified review system ensures every review comes from a real customer. No fake reviews, no manipulation - just authentic experiences.</p>
										<div className="flex flex-col sm:flex-row items-center justify-center gap-4 lg:justify-start">
											<Button size="lg" className="bg-white text-emerald-600 hover:bg-white/90 font-semibold px-8 h-12 text-base">
												See How It Works
											</Button>
											<Button variant="outline" size="lg" className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm px-8 h-12 text-base">
												Trust Center
											</Button>
										</div>
						...
						<div className="px-4 lg:px-24">
							<div className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-600 shadow-2xl isolate sm:rounded-3xl border border-purple-400/20">
								<svg viewBox="0 0 1024 1024" aria-hidden="true" className="absolute left-1/2 top-1/2 -z-10 h-[64rem] w-[64rem] -translate-y-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:left-full sm:-ml-80 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2 lg:translate-y-0">
								...
								<div className="px-6 pt-16 sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
									<div className="max-w-md mx-auto text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
										...
										<h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl mb-6">Find Exactly What You Need</h2>
										<p className="text-lg leading-8 text-white/90 mb-8 sm:text-xl">Advanced AI-powered search with 50+ filters including real-time availability, pricing tiers, accessibility features, and customer sentiment analysis.</p>
										<div className="flex flex-col sm:flex-row items-center justify-center gap-4 lg:justify-start">
											<Button size="lg" className="bg-white text-purple-600 hover:bg-white/90 font-semibold px-8 h-12 text-base">
												Try Advanced Search
											</Button>
											<Button variant="outline" size="lg" className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm px-8 h-12 text-base">
												View All Filters
						...
						<div className="px-4 lg:px-24">
							<div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-3xl p-8 lg:p-12">
								<div className="max-w-4xl mx-auto text-center">
									...
									<h2 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-6">No Hidden Fees, No Pay-to-Play</h2>
									<p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto sm:text-xl">Unlike other platforms, we don&apos;t manipulate search results based on who pays more. Every business gets a fair chance to shine based on genuine customer satisfaction.</p>
						...
						{/* Real-Time Business Information Section */}
						<div className="px-4 lg:px-24">
							<div className="relative overflow-hidden bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 shadow-2xl isolate sm:rounded-3xl border border-green-400/20">
								<div className="px-6 pt-16 sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
									<svg viewBox="0 0 1024 1024" aria-hidden="true" className="absolute left-1/2 top-1/2 -z-10 h-[64rem] w-[64rem] -translate-y-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:left-full sm:-ml-80 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2 lg:translate-y-0">
									...
									<div className="max-w-md mx-auto text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
										...
										<h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl mb-6">Always Current, Always Accurate</h2>
										<p className="text-lg leading-8 text-white/90 mb-8 sm:text-xl">Real-time business information updated by staff and verified by customers. No more showing up to closed restaurants or outdated hours.</p>
										<div className="flex flex-col sm:flex-row items-center justify-center gap-4 lg:justify-start">
											<Button size="lg" className="bg-white text-green-600 hover:bg-white/90 font-semibold px-8 h-12 text-base">
						...
						{/* Business Section - Real-Time Available */}
						<div className="px-4 lg:px-24">
							<ScrollSection category="Available Now" title="Businesses Open & Available" subtitle="Real-time availability and instant booking for immediate service" link="/search?available-now=true">
								{businesses.map((business) => (
									<BusinessCard key={business.id} business={business} />
								))}
							</ScrollSection>
