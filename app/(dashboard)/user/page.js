					...
					<div className="grid grid-cols-1 md:grid-cols-2 md:gap-4 lg:grid-cols-4">
						<div className="relative">
							<div className="transition-opacity duration-300">
								<div className="mb-8 bg-white border border-gray-300 rounded-md shadow-md dark:border-neutral-800 dark:bg-neutral-900">
					...
					<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
						{items.map((item, index) => (
							<a key={index} href={item.href}>
								<div className="relative flex flex-row h-32 p-4 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md shadow-md group dark:border-neutral-800 dark:bg-neutral-900">
