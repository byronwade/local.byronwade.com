													...
													{cats
														...
														.map((cat) => (
															<button
																key={cat.slug}
																type="button"
																className={`w-full flex items-center gap-2 px-3 py-2 text-left hover:bg-primary/10 focus:bg-primary/10 transition-colors ${formData.category === cat.name ? "bg-primary/10 text-primary font-semibold" : "text-foreground"}`}
																onClick={() => {
